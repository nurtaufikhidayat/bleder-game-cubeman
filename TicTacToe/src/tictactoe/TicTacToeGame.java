...
public class TicTacToeGame  extends JFrame {
    ...
    private class ButtonClickHandler implements ActionListener
    {
        ...
        public void actionPerformed( ActionEvent event )
        {
            ...
            else
            {
                ...
                if ( isWinner( 'X' ) == true )
                {
                    JOptionPane.showMessageDialog( null , "Congratulations, You Won! :)" ,"Tic Tac Toe:Winner",
                ...
                else
                {
                    ...
                    if ( isWinner( 'O' ) == true )
                    {
                        JOptionPane.showMessageDialog( null , "Sorry, You Lost! :(" ,"Tic Tac Toe:Winner",
                                                       JOptionPane.INFORMATION_MESSAGE );
                        resetGame();
                        return;
                    }                      
            ...
            if ( isTie() == true )
            {
                JOptionPane.showMessageDialog( null , "Draw. :|" ,"Tic Tac Toe:Tie",
                                               JOptionPane.INFORMATION_MESSAGE );
                resetGame();
            }
        }
    ...
    private void resetGame()
    {
        ...
        int answer = JOptionPane.showConfirmDialog( null , " O = Computer \n X = You \n Let Computer Go First?",
                                                    "Tic Tac Toe",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
